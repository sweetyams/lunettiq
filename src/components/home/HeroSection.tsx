  ...
  return (
    <section className="relative w-full">
      <div className="flex flex-col md:flex-row w-full">
        <div className={`relative w-full md:w-1/2 aspect-[4/5] bg-[var(--product-card-bg,#F5F5F9)] ${!leftLoaded ? 'skeleton-shimmer' : ''}`}>
        ...
        <div className={`relative w-full md:w-1/2 aspect-[4/5] bg-[var(--product-card-bg,#F5F5F9)] ${!rightLoaded ? 'skeleton-shimmer' : ''}`}>
